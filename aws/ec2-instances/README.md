...
| Debian 10      | Latest Debian Linux 10 image               | `create_debian10`    |
| Debian 10 cnspec     | Latest Debian Linux 10 image with the lastest cnspec               | `create_debian10_cnspec`    | [CIS Debian Linux 10 Benchmark - Level 1](https://aws.amazon.com/marketplace/pp/prodview-eftuxfk322rry?sr=0-1&ref_=beagle&applicationId=AWS-EC2-Console)
| Debian 10 CIS      | CIS Debian Linux 10 Benchmark - Level 1               | `create_debian10_cis`    | [CIS Debian Linux 10 Benchmark - Level 1](https://aws.amazon.com/marketplace/pp/prodview-eftuxfk322rry?sr=0-1&ref_=beagle&applicationId=AWS-EC2-Console)                                                        |
