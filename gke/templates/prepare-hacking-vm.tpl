...
#PUBLIC_IP=$(curl -H "Metadata-Flavor: Google" --noproxy "*" "http://169.254.169.254/computeMetadata/v1/instance/network/interface/0/ipv4/ipAddress/0/publicIpAddress?api-version=2017-04-02&format=text")
